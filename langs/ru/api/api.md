...
(Однако если автоматическое отслеживание зависимостей не даёт нужных вам результатов, вы можете [переопределить отслеживание зависимостей](#реактивные-утилиты).)
...
Вызов геттера (то есть `count()` или `ready()`)
...
Некоторые примитивы в Solid принимают объект "options"
