...
On the other hand, it is possible to run Solid *within*
...
Don't. Stop you right there. We use JSX the way Svelte uses their templates, to
...
To list a few to try: [Solid](https://github.com/solidjs/solid)
