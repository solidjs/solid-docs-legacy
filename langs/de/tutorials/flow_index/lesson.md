Du weißt jetzt, wie Du Listen in Solid mit `<For>` rendern kannst, aber Solid bietet auch die Komponente `<Index>`, die in bestimmten Situationen weniger rendern muss.
