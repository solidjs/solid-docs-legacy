Объединение пропсов - не единственная операция, которую мы можем выполнить. Часто мы используем деструктуризацию, чтобы использовать одни пропсы в текущем компоненте, а другие передать дочерним компонентам.
