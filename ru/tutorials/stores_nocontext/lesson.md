`Контекст` - отличный инструмент для хранилищ. Он обрабатывает внедрение, создает реактивный графы, автоматически управляет удалением и не имеет никакой цены за использование, учитывая точный рендеринг Solid.
